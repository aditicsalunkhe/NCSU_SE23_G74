#Projecct 2
## Link to our work 
[Here](https://github.com/aditicsalunkhe/Group74-CalorieApp_Server/tree/main) you can find the link to our enhanced work as a part of the project2 submission.

## Self Assessment Rubrics


It is still left to do! 


| Notes                                               | Evidence                                                    | Score |
| --------------------------------------------------- | ----------------------------------------------------------- | ----- |
| Video                                               | 2min video of new functionality, showing a significant delta from prior. | 3     |
| Workload is spread over the whole team              | [Link](https://github.com/aditicsalunkhe/Group74-CalorieApp_Server/graphs/contributors)                                      | 2     |
...
| Issues are being closed                             | evidence in GH - [Link](https://github.com/aditicsalunkhe/Group74-CalorieApp_Server/issues)                                     | 3     |
